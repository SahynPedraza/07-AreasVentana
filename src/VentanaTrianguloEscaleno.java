...
public class VentanaTrianguloEscaleno extends JFrame implements ActionListener {
	...
	private JLabel lbN1 = new JLabel("Ingresa base");
	private JLabel lbN2 = new JLabel("Ingresa altura");
	...
	/**
	 * Objeto op de la clase operaciones para calcular perimetro de triangulo escaleno
	 */
	...
	public void actionPerformed(ActionEvent arg0) {
		int r = op.areaTrianguloEscaleno(Integer.parseInt(txtN1.getText()), Integer.parseInt(txtN2.getText()));
		lbResultado.setText(String.format("El area es: \n" + "B %s * \n A %s \n = %d", txtN1.getText(), txtN2.getText(), r)); 		
	}
