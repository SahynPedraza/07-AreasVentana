...
/**
 * Objeto op de la clase operaciones para calcular perimetro de triangulo equilatero
 */
 ...
 */
	public void actionPerformed(ActionEvent arg0) {
		double r = op.areaTrianguloEquilatero(Double.parseDouble(txtN1.getText()));
		lbResultado.setText(String.format("El area %s = %f metros cuadrados", txtN1.getText(), r)); 		
	}
}
